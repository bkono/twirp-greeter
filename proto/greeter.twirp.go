...
func NewGreeterProtobufClient(addr string, client *http.Client) Greeter {
...
func (c *greeterProtobufClient) Greet(ctx context.Context, in *GreetRequest) (*GreetResponse, error) {
	url := c.urlBase + GreeterPathPrefix + "Greet"
...
func NewGreeterJSONClient(addr string, client *http.Client) Greeter {
...
func (c *greeterJSONClient) Greet(ctx context.Context, in *GreetRequest) (*GreetResponse, error) {
	url := c.urlBase + GreeterPathPrefix + "Greet"
	out := new(GreetResponse)
...
const GreeterPathPrefix = "/twirp/sh.kono.examples.greeter.Greeter/"

func (s *greeterServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "sh.kono.examples.greeter")
	...
	switch req.URL.Path {
	case "/twirp/sh.kono.examples.greeter.Greeter/Greet":
...
func (s *greeterServer) serveGreet(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *greeterServer) serveGreetJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	...
	func() {
		...
		respContent, err = s.Greet(ctx, reqContent)
	}()
...
func (s *greeterServer) serveGreetProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Greet")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
